...
public class Main {
	...
	public static void main(String[]args)
	{
		...
		URI inputURI1 = URI.createFileURI("/Users/akocatas/Dropbox/payprus-workspace/EnhancedConnectorsTest1")
				.appendSegment("EnhancedConnectorsTest1")
				.appendFileExtension(UMLResource.FILE_EXTENSION);
		
		URI inputURI2 = URI.createFileURI("/Users/akocatas/Dropbox/payprus-workspace/org.eclipse.uml2.examples.gettingstarted/models/ExtendedPO2.uml");
		
		URI inputURI3 = URI.createFileURI("/Users/akocatas/Dropbox/payprus-workspace/SampleEnhancedConnectors/RoundRobinRequester")
				.appendSegment("RoundRobinRequester_M2")
				.appendFileExtension(UMLResource.FILE_EXTENSION);
		
		EList<EObject> contents = load(inputURI3);
